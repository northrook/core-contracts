...
/**
 * @temporary This is a temporary class to support the transition to the new error reporting system.
 *
 * @phpstan-import-type ErrorArray from RuntimeError
 */
#[\Deprecated('Only for reference, use ' . ErrorReport::class . ' instead.')]
final class ErrorReportBuilder implements JsonSerializable
{
    /**
