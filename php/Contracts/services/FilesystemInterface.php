...
interface FilesystemInterface
{
    ...
    /**
     * Lists immediate entries under `$directory` as full pathnames.
     *
     * Omits `.` and `..`. Dotfiles and other hidden names are included.
     *
     * @return list<string>
     *
     * @throws FilesystemException
    ...
    /**
     * Detected MIME type for `$path`, or null when unknown / undetectable.
     */
