 ...
 *
 * This is the exclusive public-wire bypass for {@see Serializer} credential
 * refusal. Direct {@see serialize()} / {@see json_encode()} remain refused
 * when {@see \Northrook\AppEnv::isPublic()}.
 */
final class Exporter implements Resettable
{
     ...
     * {@see \Northrook\AppEnv::isPublic()} for credential refusal.
     */
