...
final readonly class Timestamp implements \Stringable
{
     ...
     * - {@see Contracts::$timezone} via {@see Contracts::tryGet()} when registered
     * - otherwise {@see \date_default_timezone_get()} (no auto-register)
     *
    ...
    public function toDateTime(
        ...
        try {
            $timezone ??= Contracts::tryGet()->timezone ?? new \DateTimeZone(\date_default_timezone_get());
