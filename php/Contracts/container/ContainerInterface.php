 ...
 *   {@see \Northrook\Contracts\Service\Tag} keyed by {@see self::DEFAULT_REFERENCE}.
...
interface ContainerInterface extends \Psr\Container\ContainerInterface
{
     ...
     * Also the reserved {@see \Northrook\Contracts\Service\Tag::$reference} for
     ...
     * @return T
     *
     * @throws \Northrook\Contracts\NotFoundException if the service is not found
     */
    public function get(
        string      $id,
     ...
     *
     * - {@see self::get()} will not throw {@see \Northrook\Contracts\NotFoundException} when this returns `true`.
