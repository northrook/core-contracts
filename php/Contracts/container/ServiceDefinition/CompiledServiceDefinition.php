...
namespace Northrook\Contracts\ServiceDefinition;
 ...
 * {@see \Northrook\Contracts\ContainerInterface::DEFAULT_REFERENCE} tag when present;
...
final readonly class CompiledServiceDefinition extends DataObject
{
     ...
     * @param \Northrook\Contracts\Container\ServiceBinding  $binding
     * @param array<int, class-string>                       $aliases
     * @param \Northrook\Contracts\Service\Tag[]             $tags
     * @param bool                                           $autowire
     * @param bool                                           $preload
