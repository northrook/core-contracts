 ...
 *
 * - If {@see \Northrook\ContainerInterface::get()} is without a `reference`, the primary `service` is returned.
 * - If {@see \Northrook\ContainerInterface::get()} is with a `reference`, a retrievable `service` is returned.
 *
