 ...
 *
 * {@see \Northrook\ContainerInterface::get()} can retrieve a `service` by any assigned alias.
 *
...
final readonly class Alias implements \IteratorAggregate, AutodiscoverInterface
{
     ...
     *
     * @return \Northrook\Container\Service\Alias
     */
    ...
    /**
     * @param \Northrook\Container\Service\Alias ...$aliases
     *
     * @return \Northrook\Container\Service\Alias
     */
