...
/**
 * HTTP facade over Symfony {@see HttpClientInterface}.
 *
 * Caching:
 ...
 *   `$cached` where present. Not a substitute for `\Symfony\Component\HttpClient\CachingHttpClient`.
 * - Local download I/O (temp file, resume, atomic promote) belongs on the handler via
 *   {@see \Northrook\FilesystemInterface}.
 */
